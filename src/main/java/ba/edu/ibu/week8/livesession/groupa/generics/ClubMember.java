...
class Run {
    public static void main(String[] args) {
        ...
        clubMembers.add(new ClubMember("Becir", 182));
        clubMembers.add(new ClubMember("Mirza", 187));
        clubMembers.add(new ClubMember("Ilma", 184));

        System.out.println(clubMembers);
        Collections.sort(clubMembers);
        System.out.println(clubMembers);
        Collections.reverse(clubMembers);
        System.out.println(clubMembers);
        Collections.shuffle(clubMembers);
        System.out.println(clubMembers);
    }
}
